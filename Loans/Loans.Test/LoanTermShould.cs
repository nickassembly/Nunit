...
namespace Loans.Test
{
   ...
   public class LoanTermShould
   {
      ...
      // Same As Restraint is only concerned with references, Not values
      [Test]
      ...
      public void Double()
      {
         ...
         Assert.That(a, Is.EqualTo(0.33).Within(0.004)); // within is helpful for testing repeating decimals
